...
from ling.helpers.tools import get_arg, get_text, resize_media
...
async def kang(client: Client, message: Message):
    ...
    if replied and replied.media:
        if replied.photo:
            ...
            return
        media_ = await client.download_media(replied, file_name="PyroKar/resources/")
    else:
...
async def tinying(client: Client, message: Message):
    ...
    im1 = Image.open("rams/split/RAMBOT.png")
    if ik.endswith(".tgs"):
